...
export class Tip extends Message<Tip> {
  ...
  /**
   * @generated from field: stredono.Currency Currency = 5;
   */
  Currency = Currency.UNKNOWN;

  /**
   * @generated from field: string RecipientId = 6;
   */
  RecipientId = "";

  /**
   * @generated from field: stredono.TipStatus Status = 7;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "RecipientId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "Status", kind: "enum", T: proto3.getEnumType(TipStatus) },
...
export class User extends Message<User> {
  ...
  /**
   * @generated from field: string PictureUrl = 6;
   */
  PictureUrl = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "PictureUrl", kind: "scalar", T: 9 /* ScalarType.STRING */ },
