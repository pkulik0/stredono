<script lang="ts">
	...
	$: if(minimumStr) minimum = parseFloat(minimumStr);
...
<AccordionItem>
	<svelte:fragment slot="header">{$t("tips")}</svelte:fragment>
	<div class="space-y-4">
		<Label>
			{$t("template")}
		...
		<div class="space-y-1">
			...
			<div class="flex flex-row space-x-2">
				...
				<Badge color="green">&lbrace;currency&rbrace;</Badge>
			</div>
		</div>
